...
public:
	...
	//Constructor
	Unit_Box(event_function action, fPoint center, SDL_Rect spriteList[4], SDL_Texture* tex, UI_Element* parent = NULL, SDL_Texture* TimerTexture = NULL, int timeCreator = 0, int unitCost=0,bool* _abletoCraft=nullptr,SDL_Scancode* Hotkey = nullptr, ui_type type = ui_type::ACTION_BOX);
	bool Start() override;
